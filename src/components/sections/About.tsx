    ...
    <section className={`${styles.paddings} relative z-10`}>
      ...
      >
        ...
        <motion.p variants={fadeIn("up", "tween", 0.2, 1)}
          className="mt-2 font-normal sm:text-2xl text-lg text-center text-gray-300"
        >
        ...
        <motion.img variants={fadeIn("up", "tween", 0.3, 1)} src="/imgs/icons/arrow-down.svg" alt="arrow down"
